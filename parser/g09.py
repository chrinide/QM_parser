...
#
class G09(Chrom):
    '''A class to parse G09 td logfiles.'''
    ...
    def get_data(self):
        '''Fills in class attributes with the data from G09 td logfile.'''
...
if __name__ == '__main__':
    ...
    # a = G09("../data/G09/g09_td2.log")
    # a.save_es_analysis(4, 1, [5, 19])
    # a.save_visdip(center=[1,4])


    # a = G09("../data/G09/g09_td.log")
    # a.save_es_analysis(28, 26, 27)
    # a.save_visdip()
    pass
